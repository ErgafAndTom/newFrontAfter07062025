...
className Side extends React.Component {
	...
	_dragStartItem(evt)
	{
		...
		this.$gridItems.on('dragover', (e) => {
			e.preventDefault();
			if ($(e.currentTarget).hasclassName('ple-grid__item-hover')) return;
			$(e.currentTarget).addclassName('ple-grid__item-hover');
		}).on('dragleave', (e) => {
			e.preventDefault();
			$(e.currentTarget).removeclassName('ple-grid__item-hover');
		}).on('drop', (e) => {
			e.preventDefault();
			$(e.currentTarget).removeclassName('ple-grid__item-hover');
	...
	_touchStartItem(e)
	{
		this.$dragItem = $(e.currentTarget)
			...
			.addclassName('ple-side__placeholder')
